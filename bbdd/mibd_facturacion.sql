...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-08-2019 a las 04:34:51
...
--
-- Base de datos: `mibd_facturacion`
--
...
(1, 88226017, '2018-10-29', 1, 88246),
(2, 12348765, '2018-10-20', 1, 88246);
...
(88246, 'Cesar', 'Bolado', '', '0000-00-00', 3162218072, 'cesarbolado@gmail.com'),
...
(1090384538, 'Oscar', 'Gonzalez', 'La Libertad', '2019-08-04', 413123, 'oigonzalez83@misena.edu.co'),
...
--
ALTER TABLE `factura`
  ADD CONSTRAINT `cliente_ibfk_4` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`codigo`) ON UPDATE CASCADE,
  ADD CONSTRAINT `pago_ibfk_3` FOREIGN KEY (`num_pago`) REFERENCES `modo_pago` (`num_pago`) ON UPDATE CASCADE,
  ADD CONSTRAINT `vendedor_ibfk_2` FOREIGN KEY (`id_vendedor`) REFERENCES `vendedor` (`id_vendedor`) ON UPDATE CASCADE;
